...
- Name: KAN-8/post-endpoints.api.spec.ts >> KAN-8: DummyJSON POST Endpoints >> TC-KAN8-POST-004: Create cart with product
- Location: tests/KAN-8/post-endpoints.api.spec.ts:61:7
...
Call log:
  - → POST https://api.dummyjson.com/carts/add
