...
- Name: KAN-4/put-endpoints.api.spec.ts >> KAN-4: PUT /objects/{id} >> TC-008: PUT with name only — data becomes null
- Location: tests/KAN-4/put-endpoints.api.spec.ts:41:7
