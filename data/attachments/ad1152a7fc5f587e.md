...
- Name: KAN-4/put-endpoints.api.spec.ts >> KAN-4: PUT /objects/{id} >> TC-007: PUT full replace updates name and data
- Location: tests/KAN-4/put-endpoints.api.spec.ts:26:7
