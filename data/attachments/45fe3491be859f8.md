...
- Name: KAN-8/post-endpoints.api.spec.ts >> KAN-8: DummyJSON POST Endpoints >> TC-KAN8-POST-005: Create todo item
- Location: tests/KAN-8/post-endpoints.api.spec.ts:83:7
...
Call log:
  - → POST https://api.dummyjson.com/todos/add
