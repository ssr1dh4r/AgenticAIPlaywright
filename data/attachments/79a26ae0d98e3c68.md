...
- Name: KAN-4/post-endpoints.api.spec.ts >> KAN-4: POST /objects >> TC-005: POST create object with name and data returns 200 with assigned ID
- Location: tests/KAN-4/post-endpoints.api.spec.ts:16:7
